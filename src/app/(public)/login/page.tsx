...
export default function LoginPage() {
	...
	return (
		<div className="flex h-full w-full max-w-7xl items-center m-auto">
			<div className="grid grid-cols-1 rounded-xl bg-slate-100 p-2 dark:bg-gray-700 lg:grid-cols-5">
